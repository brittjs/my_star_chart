...
module.exports = {
  ...
  getAllFriendsForUser: function* getAllFriendsForUser(next) {
    ...
    var userFriends = yield db.sequelize.query("SELECT * FROM \"Users\" WHERE \"id\" in (SELECT \"Friend1Id\" FROM \"Friendships\" WHERE \"Friend2Id\"=1 UNION SELECT \"Friend2Id\" FROM \"Friendships\" WHERE \"Friend1Id\"=1)", { type: db.sequelize.QueryTypes.SELECT});
